...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 189.95
  #define DEFAULT_bedKi 37.10
  #define DEFAULT_bedKd 648.43
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.106 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -34, 14, -1.78 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  255, 10, (Z_MIN_POS + 2.7) } }
  #define NOZZLE_CLEAN_END_POINT   { { 240, 11, (Z_MIN_POS + 2.7) } }
