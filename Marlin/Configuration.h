...
#define STRING_CONFIG_H_AUTHOR "(Alex, Personal config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Endy"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 176.73
  #define DEFAULT_bedKi 34.52
  #define DEFAULT_bedKd 603.24
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.4, 80.4, 400, 694.74 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1750, 1750, 750, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -34, 14, -1.515 }
...
//#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 141.36
  #define XY_DIAG_BD 141.44
  #define XY_SIDE_AD 100.17
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  255, 6, (Z_MIN_POS + 1.7) } }
  #define NOZZLE_CLEAN_END_POINT   { { 240, 6, (Z_MIN_POS + 1.7) } }

  #if ENABLED(NOZZLE_CLEAN_PATTERN_CIRCLE)
    #define NOZZLE_CLEAN_CIRCLE_RADIUS 2                      // (mm) Circular pattern radius
